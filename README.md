...
iCloud Mail desktop app for Windows. Loads [icloud.com/mail](https://www.icloud.com/mail) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-mail://` protocol handler

## Installation

1. Download the latest installer from [Releases](https://github.com/taylorivanoff/icloud-mail-windows/releases)
